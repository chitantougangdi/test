...
<?php 
$this->header();
?><div class="new-price-banner" style="display: none;">
    <div class="container">
...
?>                <div class="col-sm-10">
                                                ...
                                                <div class="input-text pt2ype">
                                                    <label class="gggh1">
                                                         ...
                                                         <input type="radio" name="type"
                                                               value="0" <?php echo $data["type"] == 0 ? "checked" : "";?>> 安卓
                                                       
                                                       
                                                    </label>
                                                    <label class="<?php echo $data["type"] == 1 ? "selon" : "";?>">
                                                        <input type="radio" name="type"
                                                               value="1" <?php echo $data["type"] == 1 ? "checked" : "";?>> 苹果
			...
			<div class="col-sm-6">
				<div class="input-text">
					<label class="gggh1" ><input type="radio" name="bidtype" value="0" checked> 默认</label> <label><input type="radio" name="bidtype" value="1"> 自定义</label>
				</div>
				<div class="input-text" id="bidtype_box" style="display:none;">
					<input type="text" id="bundle_id" name="bundle_id" class="form-control input-change1" rows="5" placeholder="自定义包名，例如 com.aaa.baidu" value="<?php echo $data["bundle_id"];?>">
					<div class="error1 color-danger">包名格式如：com.xuanfeng.app</div>
                                        ...
                                        <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-6">
               <div class="input-text">
					<label class="gggh1"><input type="radio" name="bidtypee" value="0" checked> 默认</label> <label><input type="radio" name="bidtypee" value="1"> 自定义</label>
				</div>
                                    ...
                                    <div class="step3 step-common encapsulation3">
                                        ...
                                        $(".pub-radio").change(function(){
                                            ...
                                            if(radioVal == "1")
                                            {
                                                ...
                                                $("#pdata0").attr("data-price","<?php echo $IN_WEBVIEWPOINTS_IPA[0];?>")
                                                $("#pdata1").attr("data-price","<?php echo $IN_WEBVIEWPOINTS_IPA[1];?>")
                                                $("#pdata2").attr("data-price","<?php echo $IN_WEBVIEWPOINTS_IPA[2];?>")
                                                $("#pdata3").attr("data-price","<?php echo $IN_WEBVIEWPOINTS_IPA[3];?>")
                                                $("#pdata4").attr("data-price","<?php echo $IN_WEBVIEWPOINTS_IPA[4];?>")
                                                // data-price="<?php echo $IN_WEBVIEWPOINTS[1];?>">

                                                $('#price').html('<b class="color-danger">' + "<?php echo  $IN_WEBVIEWPOINTS_IPA[0] ?>" + '</b>元');

                                            }
                                            else
                                            {
                                                 
                                                $("#pdata0").attr("data-price","<?php echo $IN_WEBVIEWPOINTS[0];?>")
                                                $("#pdata1").attr("data-price","<?php echo $IN_WEBVIEWPOINTS[1];?>")
                                                $("#pdata2").attr("data-price","<?php echo $IN_WEBVIEWPOINTS[2];?>")
                                                $("#pdata3").attr("data-price","<?php echo $IN_WEBVIEWPOINTS[3];?>")
                                                $("#pdata4").attr("data-price","<?php echo $IN_WEBVIEWPOINTS[4];?>")
                                                

                                                $('#price').html('<b class="color-danger">' + "<?php echo  $IN_WEBVIEWPOINTS[0] ?>" + '</b>元');

                    
                                            }

                                            $("#pdata0").addClass('active').siblings().removeClass('active');
                                            $('ul.period>li .icon-radio').removeClass('icon-radio-checked');
                                            $("#pdata0").find('.icon-radio').addClass('icon-radio-checked');
...
if (!$id) {
	?>      
	 <div class="tit"><font color="#333">选择有效期</font></div>
	 <div class="textggggd">
      <p class="fl"><span id="appNameText"></span> </p>
        </div>
	       <div class="common">
	...
	if (!empty($IN_WEBVIEWPOINTS[0])) {
		?>                                                            <li id="pdata0" class="clearfix  <?php echo $active;?>"
                                                                ...
                                                                <span class="fl"><font color="#333">一个月</font></span>
                                                            </li>
                                                            <?php 
		$active = $checked = "";
	}
	...
	if (!empty($IN_WEBVIEWPOINTS[1])) {
		...
		?>                                                            <li id="pdata1" class="clearfix  <?php echo $active;?>"
                                                                ...
                                                                data-price="<?php echo $IN_WEBVIEWPOINTS[1];?>">
                                                                <span class="icon icon-radio fl <?php echo $checked;?>"></span>
                                                                <span class="fl"><font color="#333">三个月</font></span>
                                                            </li>
                                                            <?php 
		$active = $checked = "";
	}
	...
	if (!empty($IN_WEBVIEWPOINTS[2])) {
		...
		?>                                                            <li id="pdata2" class="clearfix  <?php echo $active;?>"
                                                                ...
                                                                <span class="icon icon-radio fl <?php echo $checked;?>"></span>
                                                                <span class="fl"><font color="#333">六个月</font></span>
                                                            </li>
                                                            <?php 
		$active = $checked = "";
	}
	...
	if (!empty($IN_WEBVIEWPOINTS[3])) {
		...
		?>                                                            <li id="pdata3" class="clearfix  <?php echo $active;?>"
                                                                ...
                                                                <span class="icon icon-radio fl <?php echo $checked;?>"></span>
                                                                <span class="fl"><font color="#333">一年</font></span>
                                                            </li>
                                                            <?php 
		$active = $checked = "";
	}
	...
	if (!empty($IN_WEBVIEWPOINTS[4])) {
		...
		?>                                                            <li id="pdata4" class="clearfix  <?php echo $active;?>"
                                                                ...
                                                                <span class="icon icon-radio fl <?php echo $checked;?>"></span>
                                                                <span class="fl"><font color="#333">永久</font></span>
                                                            </li>
                                                        <?php 
	}
	?>                                                    </ul>
                                                    <script>
                                                        $('ul.period>li').click(function () {
                                                            ...
                                                            $('#price').html(' <div class="money">应支付<span class="dangerr">￥' + $(this).attr('data-price') + '.00</span></div>');
                                                        });
                                                    </script>
                                                </div>
                                            </div>
            ...
            <div class="tit"></div>
             ...
             <div class="common">
            <div class="tit"><font color="#333">选择支付方式</font></div>
            
            <ul class="clearfix list3"><li class="clearfix  active" data="balance">
         ...
         <div class="common">
            <div class="tittt"><font color="#333"></font></div>
